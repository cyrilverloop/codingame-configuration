...
- configuration for "When pigs fly".
- configuration for "Xorandor".
- configuration for "The two piles difference".
- configuration for "Sliding puzzle".
- configuration for "Mathematics for big ears".
- configuration for "Nurikabe".
...
- configuration for "The Balanced Centrifuge Problem".
...
- configuration for "The Lucky Number".
- configuration for "Hourglass".
- configuration for "The Crime Scene".
- configuration for "Dungeon Designer".
...
- configuration for "Shape Recognition".
- configuration for "n Queens".
- configuration for "Horn-SAT solver".
- configuration for "Tetris".
- configuration for "Expand the polynomial".
...
- configuration for "Hit the road".
- configuration for "Sum of odd".
- configuration for "Parsing context-free grammar".
- configuration for "Cheat Solving".
- configuration for "Divisibility of Fibonacci numbers sum".
- configuration for "To Sky’s Edge".
- configuration for "The hungry duck - part 1".
- configuration for "Dominoes solver".
- configuration for "Inertia ride".
- configuration for "A Man with a Plan".
...
- TypeScript, C++ and Java code for
...
- configuration for "Misère Nim".
- configuration for "Simple safecracking".
...
## [1.13.1] - 2025-03-31
### Fixed
- configuration of test "So Many Solutions" for "Equation Search".
...
- configuration for "Highest truncated pyramid".
- configuration for "Sign (programming) language".
- configuration for "Secret Message Decoding".
- configuration for "Boggle".
- configuration for "TXT2HTML".
- configuration for "Fractal Carpet".
- configuration for "Neighbor-Sum Grids".
...
- configuration for "The Highest Building".
- configuration for "X egg problem".
- configuration for "Paper-folding curve".
- configuration for "SHA-256 Hash".
- configuration for "Candies".
- configuration for "Snooker Ball Collision".
- configuration for "Drawing Polygons".
- configuration for "Binary Permutations".
- configuration for "Chateau assiegé".
- configuration for "Longest Palindrome".
- configuration for "Solveur de mini sudoku".
...
- configuration for "Thomas and the Freight Cars".
...
- configuration for "Cubax Folding".
- configuration for "Magic count of numbers".
